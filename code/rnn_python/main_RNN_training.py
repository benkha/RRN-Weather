...
for cluster_id in cluster_subset:
    ...
    model.fit(features_trn, targets_trn, validation_frequency=1000, air_id=str(cluster_id))
...
model.fit(features_trn, targets_trn, validation_frequency=1000, air_id="all")
